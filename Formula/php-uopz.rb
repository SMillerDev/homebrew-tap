class PhpUopz < Formula
  ...
  post_install_steps do
    unless_path_exists "php/8.5/conf.d/ext-uopz.ini", base: :etc do
      copy "ext-uopz.ini", "php/8.5/conf.d/ext-uopz.ini",
           source_base: :pkgetc, target_base: :etc
    end
  end

  test do
    assert_match "uopz", shell_output("#{formula_opt_bin("php")}/php -m").downcase,
